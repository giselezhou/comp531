...
var redis = require('redis')
    .createClient('redis://h:pfb377bf52288bfd6987c5f5a57e24fee1a5d5bd29735063f' +
        'f2ff9a4c5eed5736@ec2-34-206-56-140.compute-1.amazonaws.com:11279')
...
const login = (req, res) => {
    ...
    if(users[username]){
        ...
        if(newHash === users[username].hash){
            redis.hmset(newHash, users[username])

...
if (!process.env.CLOUDINARY_URL) {
    process.env.CLOUDINARY_URL = "cloudinary://872524154752855:17f5jROfcCn83jMQ63xXXBj7bJg@htbk7ldr8"
}
...
const uploadTextAndImage = (publicId) => (req, res, next) =>{
    multer().single('text')(req, res, () => {
        if (!req.body.text) {
            req.textMsg = null;
        } else if (!req.body.text[0] || req.body.text[0] === 'undefined') {
            req.textMsg = 'What you want to add'
        } else {
...
module.exports = { uploadImage, uploadTextAndImage }
